...
export default () => {
    ...
    return <Collapse>
        <Panel header="Filter Logs" key="filter">
            <Form ref={form} initialValues={{ initialData }} onValuesChange={(_, v) => onValuesChanged(v)}>
                ...
                <Row>
                    ...
                    <Col span={12} style={{ padding: "0 10px" }}>
                        <Form.Item name="headers" label="Headers" valuePropName="headers">
                ...
                <Row>
                    <Col span={12} style={{ padding: "0 10px" }}>
                        <Form.Item name="cookies" label="Cookies" valuePropName="cookies">
                            <KeyValues fieldName="cookies" />
                        </Form.Item>
                    </Col>

                    <Col span={12} style={{ padding: "0 10px" }}>
                        <Form.Item name="queryStringParameters" label="Query" valuePropName="queryStringParameters">
            ...
            <Row>
                <Col>
                    <Button type="dashed" icon={<RetweetOutlined />} onClick={reset}>Reset Filter</Button>
                </Col>
            </Row>
        </Panel>
    </Collapse>
