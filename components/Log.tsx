...
export default ({ log }: { log: Log }) => {
    ...
    if (log.proxy) {
        ...
        response = (
            <Response
                title="Matched Expectation"
                headers={log.expectation.httpResponse.headers}
                body={log.expectation.httpResponse.body}
            />
        )
    } else {
        response = (
            <Empty
                ...
                description="No  Matched Expectation"
            />
        )
    }
