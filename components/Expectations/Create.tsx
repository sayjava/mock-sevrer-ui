...
export default ({ onDone }) => {
    ...
    return <div style={{ width: "100%" }}>
        <Space title="New Expectation" direction="vertical" size="middle" style={{ width: "100%" }}>
            {error && <Alert type="error" message="Expectation Error" description={error.toString()} />}
            <CodeMirror
                ref={editor}
                value={expectation}
            ...
            />
            <Button type="primary" onClick={createExpectation}>Create Expectation</Button>
        </Space>
    </div>
}